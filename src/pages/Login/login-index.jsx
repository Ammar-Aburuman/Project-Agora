            ...
            <Grid.Column style = {{maxWidth: 400}}>
                ...
                <Form onSubmit={formik.handleSubmit} size="large">
                    <Segment raised>
                        ...
                        {formik.touched.email && formik.errors.email && popUp === false ? <label style={{color:"red"}}>{formik.errors.email}</label> : null}
                        ...
                        {formik.touched.password && formik.errors.password  && popUp === false ? <label style={{color:"red"}}>{formik.errors.password}</label> : null}
